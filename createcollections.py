...
# collection 1
User1 = User(name="Kawthat Al-Harbi", email="kaw18thar@yahoo.com",
             picture='logo.png')
session.add(User1)
session.commit()

col1 = Collection(user_id=1, name="January Collection")
...
col2 = Collection(user_id=1, name="February Collection")
session.add(col2)
session.commit()
