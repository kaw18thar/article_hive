...
# collection 1
User1 = User(name="Kawthat Al-Harbi", email="kaw18thar@gmail.com",
             picture='/static/logo.png')
session.add(User1)
session.commit()

col1 = Collection(user_id=1, name="Spring Collection")

session.add(col1)
session.commit()

art1 = ArticleCollection(user_id=1, name="Fagaa Is Sprouting Rapidly This Season",
...
art2 = ArticleCollection(user_id=1, name="Families Expenditure Is Declining For the Forth Year",
...
col2 = Collection(user_id=1, name="Summer Collection")
session.add(col2)
session.commit()


art3 = ArticleCollection(user_id=1, name="Hot And Long Summer, Weather Experts Forewarning",
...
art4 = ArticleCollection(user_id=1, name="Vacationers Are In For A Wide Variety Of Activities This Summer",
